...
export default function FacultyPublications({publications}) {
  return (
    <>
      <section className="mx-auto w-full max-w-7xl px-4 py-4">
        <div className="flex flex-col space-y-4  md:flex-row md:items-center md:justify-between md:space-y-0">
          <div className='mx-auto text-center mb-8'>
            <p className="text-2xl font-bold underline">Publications</p>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="divide-y divide-gray-200 bg-white">
                    {publications.map((publication) => (
                      <tr key={publication.name}>
                        <td className="whitespace-nowrap px-4 py-4">
                          <div className="flex items-center">
                            <div className="ml-4">
                              <div className="text-sm font-normal  text-gray-900">{publication.year}</div>
                            </div>
                          </div>
                        </td>
                        ...
                        <td className="whitespace-nowrap px-4 py-4 text-right text-sm font-medium">
                          <a href={publication.url} className="text-gray-700">
                            Read
                          </a>
                        </td>
                      </tr>
