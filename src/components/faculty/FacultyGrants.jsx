                      ...
                      <tr key={grant.name}>
                        <td className="whitespace-nowrap px-4 py-4">
                          <div className="flex items-center">
                            <div className="ml-4">
                              <div className="text-sm font-normal  text-gray-900">{grant.year}</div>
                            </div>
                          </div>
                        </td>
                        <td className="whitespace-nowrap px-12 py-4">
                          <div className="text-sm text-gray-900 ">{grant.title}</div>
                        </td>
                        <td className="whitespace-nowrap px-12 py-4">
                          <div className="text-sm text-gray-900 ">{grant.inventors}</div>
                        </td>
                        <td className="whitespace-nowrap px-4 py-4">
                        ...
                        <td className="whitespace-nowrap px-4 py-4 text-right text-sm font-medium">
                          <a href={grant.url} className="text-gray-700">
                            View
                          </a>
                        </td>
                      </tr>
